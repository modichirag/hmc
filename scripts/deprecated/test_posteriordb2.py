...
from pyhmc import PyHMC_multistep_tries, PyHMC
...
fdir= '/mnt/ceph/users/cmodi/hmc/outputs_long2/%s//'%posname
...
hmc_multi = PyHMC_multistep_tries(log_prob, grad_log_prob, invmetricfid)
