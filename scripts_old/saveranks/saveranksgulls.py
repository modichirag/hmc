...
ndata = 3
olong = 1
#posname = 'gulls-3dnq0p8'
posname = 'gulls'
suff = '-4dhmctnuts'
posname = posname + suff
...
fpname = './data2/%s/nbins%d/olong%d/ess%s.json'%('gulls',  20, olong, suff)
with open(fpname, 'w') as fp:
    json.dump(ess, fp, sort_keys=True, indent=4)

fpname = './data2/%s/nbins%d/olong%d/evals%s.json'%('gulls',  20, olong, suff)
with open(fpname, 'w') as fp:
