...
from pyhmc import PyHMC_multistep_tries
...
##
#fpath = './outputs_long/funnel/Ndim%02d//'%ndim
fpath = '/mnt/ceph/users/cmodi/hmc/outputs_long2/funnel/Ndim%02d//'%ndim
...
hmc = PyHMC_multistep_tries(log_prob, grad_log_prob)
def step(x):
